...
for ds in all_ds:
    data_path = INPUT_DIR / '附件2：钢板零件数据.xlsx'
    speed_path = INPUT_DIR / '附件3：工艺用时计算表.xlsx'
...
# Save results
result_dir = run_result_dir(create_run_directory(f"test_full_{uuid.uuid4().hex[:8]}"))
result_file = result_dir / 'regression_results.json'
