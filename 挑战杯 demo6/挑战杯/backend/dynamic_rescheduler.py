...
class DynamicRescheduleService:
    ...
    def __init__(
        ...
        self.store = ResultStore(self.run_dir.parent, self.run_dir.name)
    ...
    def clear_uploaded_file(self) -> dict:
        ...
        state["input_path"] = str(self.input_path)
        state["speed_table_path"] = str(self.speed_table_path) if self.speed_table_path else None
    ...
    def reschedule(self, payload: dict, cancel_check=None) -> dict:
        ...
        state = {
            ...
            "speed_table_path": str(effective_speed_path) if effective_speed_path else None,
